...
// код у меня не организован, точнее сделан по принципу от 1 таски до 9 сверху вниз
// просто таску за таской писал, сдавал задания на скорую чтобы до выходных, 
// так как мне дали ясно понять, что время затраченное влияет
// как я бы это рефакторил или организовывал я примерно понимаю, 
// но это на опыте,а не на понимании как правильно
// !!!хотелось бы понимать как правильно!!! 
// если есть какой либо хороший (который рекомендуете) ресурс (статья и т.п.) на эту тему то можете мне ссылку дать
